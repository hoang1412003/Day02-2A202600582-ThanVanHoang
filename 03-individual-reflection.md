...
| Challenge | Chất vấn bài toán Education Support về dữ liệu hành chính mật và tính định lượng của trạng thái Burnout | Nhóm loại bớt scope quá rộng và mơ hồ, không khả thi trong bài lab |
...
|---|---|---|---|---|
| Scan | Gợi ý mở rộng các problem quan sát được theo các lăng kính | Giúp cấu trúc hóa 5 vấn đề rành mạch, gọi tên đúng "nỗi đau" của từng Actor | gợi ý quá rộng | Bỏ các ý không có workflow thật |
